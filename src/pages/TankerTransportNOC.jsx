...
import {
    Truck, FileText, UploadCloud, CheckCircle, ArrowRight, ArrowLeft,
    Building2, Info, Download, LayoutDashboard, LogOut, ChevronRight,
    Plus, Eye, Clock, MapPin
} from 'lucide-react';
import { useNavigate } from 'react-router-dom';

const TankerTransportNOC = ({ activeCompany, setActiveCompany }) => {
    ...
    const [myApplications, setMyApplications] = useState([
        { id: 'TANK-2025-001', vehicleNo: 'RJ-14-AB-1234', capacity: '5000 L', status: 'Active', date: '2024-12-01', expiry: '2025-12-01' },
        { id: 'TANK-2025-002', vehicleNo: 'RJ-14-CD-5678', capacity: '10000 L', status: 'Pending', date: '2024-12-18', expiry: '-' }
    ]);
    ...
    const steps = [
        { id: 1, label: 'Vehicle Details', icon: <Truck size={18} /> },
        { id: 2, label: 'Route Information', icon: <MapPin size={18} /> },
        { id: 3, label: 'Documentation', icon: <FileText size={18} /> },
        { id: 4, label: 'Review & Submit', icon: <CheckCircle size={18} /> }
    ];

    const handleLogout = () => {
        if (confirm('Exit Tanker Transport NOC? Progress may be lost.')) navigate('/dashboard');
    };

    const TankerDashboard = () => (
        <div className="tanker-dash animated">
            <div className="dash-stats">
                <div className="stat-card">
                    <div className="s-icon blue"><Truck size={24} /></div>
                    <div className="s-info">
                        <strong>{myApplications.filter(a => a.status === 'Active').length}</strong>
            ...
            <div className="applications-table">
                <div className="table-header">
                    <h3>My Tanker Transport NOCs</h3>
            ...
            case 1:
                return (
                    <div className="wizard-step animated">
                        <h3>1. Vehicle & Tanker Details</h3>
                        <div className="form-layout">
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" value={formData.vehicleNumber} onChange={e => setFormData({ ...formData, vehicleNumber: e.target.value })} placeholder="e.g., RJ-14-AB-1234" />
                            </div>
                            <div className="form-group">
                                ...
                                <select value={formData.vehicleType} onChange={e => setFormData({ ...formData, vehicleType: e.target.value })}>
                                    ...
                                    <option>Bulk Water Carrier</option>
                                    <option>Mobile Water Unit</option>
                                </select>
                            </div>
                            <div className="form-group">
                                <label>Tank Capacity (Liters) *</label>
                                <input type="number" value={formData.tankCapacity} onChange={e => setFormData({ ...formData, tankCapacity: e.target.value })} placeholder="e.g., 5000" />
                            </div>
                            <div className="form-group">
                                <label>Purpose *</label>
                    ...
                    <div className="wizard-step animated">
                        ...
                        <div className="form-layout">
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" value={formData.sourceLocation} onChange={e => setFormData({ ...formData, sourceLocation: e.target.value })} placeholder="Water source location" />
                            </div>
                            <div className="form-group full">
                                <label>Destination / Service Area *</label>
                                <textarea value={formData.destinationArea} onChange={e => setFormData({ ...formData, destinationArea: e.target.value })} placeholder="Areas where water will be supplied" rows="3"></textarea>
                            </div>
                            <div className="form-group full">
                                <label>Proposed Route</label>
                                <textarea placeholder="Describe the route for water transportation (optional)" rows="3"></textarea>
                            </div>
                        </div>
                    </div>
                );
                    ...
                    <div className="wizard-step animated">
                        ...
                        <div className="document-checklist">
                            <div className="doc-item">
                                ...
                                <label htmlFor="doc1">Vehicle Registration Certificate (RC)</label>
                            </div>
                            <div className="doc-item">
                                <input type="checkbox" id="doc2" />
                                <label htmlFor="doc2">Vehicle Insurance Certificate</label>
                            </div>
                            <div className="doc-item">
                                <input type="checkbox" id="doc3" />
                                <label htmlFor="doc3">Driver License</label>
                            </div>
                            <div className="doc-item">
                                <input type="checkbox" id="doc4" />
                                <label htmlFor="doc4">Pollution Control Certificate (PUC)</label>
                            </div>
                            <div className="doc-item">
                                <input type="checkbox" id="doc5" />
                                <label htmlFor="doc5">Water Quality Test Certificate</label>
                            </div>
                        </div>
                    ...
                    <div className="wizard-step animated">
                        ...
                        <div className="review-summary">
                            ...
                            <div className="summary-item">
                                ...
                                <span>{formData.tankCapacity} Liters</span>
                            </div>
                            <div className="summary-item">
                                <label>Purpose:</label>
                            ...
                            <div className="summary-item">
                                ...
                                <span>{formData.destinationArea}</span>
                            </div>
                        </div>
                        <div className="consent-box">
                            <input type="checkbox" id="consent" />
                            <label htmlFor="consent">I confirm that all information provided is accurate and I will comply with all regulations for water transportation in Rajasthan.</label>
                        </div>
                    </div>
                );
            default:
                return <div className="success-screen">
                    ...
                    <p>Your tanker transport NOC application has been submitted. Reference ID: <strong>TANK-2025-{Math.floor(Math.random() * 900 + 100)}</strong></p>
    ...
    return (
        <div className="sys-canvas">
            <aside className={`sys-sidebar ${isSidebarOpen ? 'expanded' : 'collapsed'}`}>
                <div className="sb-header">
                    <div className="sb-logo" onClick={() => navigate('/dashboard')}>
                        ...
                        {isSidebarOpen && <span>Tanker Transport</span>}
                    </div>
                ...
                <nav className="sb-nav">
                    ...
                    <button className={`sb-item ${activeMenuItem === 'dashboard' ? 'active' : ''}`} onClick={() => setActiveMenuItem('dashboard')}><Truck size={18} /> {isSidebarOpen && "My Permits"}</button>
                ...
                <header className="sys-header">
                    <div className="header-branding">
                        ...
                        <div className="branding-txt">
                            <h2>Tanker / Transportation NOC Portal</h2>
                            <p>Bulk Water Supply Authorization • Rajasthan Ground Water Authority</p>
                        </div>
                    </div>
            ...
            <style jsx>{`
                ...
                .logo-box { width: 40px; height: 40px; background: linear-gradient(135deg, #0ea5e9, #0284c7); border-radius: 12px; display: flex; align-items: center; justify-content: center; font-weight: 800; font-size: 1.2rem; }
                ...
                .sb-item.active { background: linear-gradient(90deg, rgba(59, 130, 246, 0.2), transparent); color: white; border-left: 3px solid #0ea5e9; }
                ...
                .ac-id { font-size: 0.7rem; color: #0ea5e9; font-weight: 700; background: white; padding: 2px 6px; border-radius: 4px; }
                ...
                .help-btn:hover { background: #f8fafc; color: #0ea5e9; }
                .logout-btn:hover { background: #fef2f2; border-color: #fecaca; color: #dc2626; }
                .sys-viewport { flex: 1; overflow-y: auto; background: radial-gradient(circle at 0% 0%, #f9fafb, #f0f9ff 100%); padding: 40px; }
                .tanker-dash { animation: fadeIn 0.5s ease-out; }
                ...
                .btn-primary { background: #0ea5e9; color: white; border: none; padding: 12px 24px; border-radius: 12px; font-weight: 700; cursor: pointer; display: flex; align-items: center; gap: 8px; transition: all 0.2s; }
                ...
                .btn-icon:hover { border-color: #0ea5e9; color: #0ea5e9; }
                ...
                .p-node.active .node-icon { background: #0ea5e9; border-color: #0ea5e9; color: white; }
                .p-node span { font-size: 0.75rem; font-weight: 700; color: #64748b; }
                .p-node.active span { color: #0ea5e9; }
                .p-bar { position: absolute; top: 20px; left: 0; right: 0; height: 2px; background: #e2e8f0; z-index: 0; }
                .p-bar-fill { height: 100%; background: #0ea5e9; transition: width 0.3s; }
                ...
                .form-group input:focus, .form-group select:focus, .form-group textarea:focus { border-color: #0ea5e9; box-shadow: 0 0 0 4px rgba(14, 165, 233, 0.1); }
                ...
                .success-screen strong { color: #0ea5e9; }
...
export default TankerTransportNOC;
